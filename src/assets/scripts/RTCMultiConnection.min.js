    ...
    var FileProgressBarHandler = (function () {
        function handle(connection) {
            ...
            //    div.setAttribute('style' , 'max-width : 90%;');
                div.title = file.name;
                div.innerHTML = '<label>0%</label> <progress style="padding: 6px ;"></progress>';
            ...
            connection.onFileEnd = function (file) {
              ...
              var firstNameUpperCase = null;
                ...
                // file share UI
                var div =  helper.div;
                html = '<p><a style="font-size: calc(0.5vw + 0.5vh); color:#000;" href="' + file.url + '" download="' + file.name + '">' +
                ...
                html += formatDateRTC(new Date())+ ' <span class="time-left">' + firstNameUpperCase +'</span>';
                div.innerHTML = html;
