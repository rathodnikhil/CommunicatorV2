    ...
    var FileProgressBarHandler = (function () {
        function handle(connection) {
            ...
            connection.onFileEnd = function (file) {
                ...
                var div = helper.div;
                div.innerHTML = '<div class="row" style=" margin: 10px;background-color: #fff; padding:15px;"><div class="col-md-6">' +
                    '<a style="font-weight: normal;font-size: 1.3vh;" href="' + file.url + '" download="' + file.name + '">' +
                    '<strong>' + file.name + '</strong><span><i class="fa fa-download" style="color: #43A047; margin-left:10px;" aria-hidden="true"></i></span> </a>' +
                    '</div>' +
                    '<div class="col-md-6 file-sender-name">' +
                    ' <h6>' + file.extra['senderId'] + '</h6>' +
                    '</div>' +
                    '</div>';
