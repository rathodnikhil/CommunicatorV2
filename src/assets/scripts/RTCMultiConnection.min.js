...
var RTCMultiConnection = function (roomid, forceOptions) {
    ...
    function MultiPeers(connection) {
        ...
        function initFileBufferReader() {
            ...
            connection.fbr.chunkSize = 60000;
    ...
    var FileProgressBarHandler = (function () {
        function handle(connection) {
            ...
            connection.onFileStart = function (file) {
                ...
                div.title = file.name;
                div.innerHTML = '<label style="margin-left: 10px;">0%</label> <progress style="padding: 6px;"></progress>';
                if (file.remoteUserId) {
                    div.innerHTML += '&nbsp;&nbsp;' + file.extra['senderId'] + ' sharing file.';
                }
            ...
            connection.onFileEnd = function (file) {
                ...
                // debugger;
                //  var attendeeFullName = file.extra['senderId'];
                ...
                // document.getElementById('downloadedFilesAnchor').click();
            };
