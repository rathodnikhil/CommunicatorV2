...
connection.onstream = function (event) {
    ...
    if (event.stream.isScreen) {
        if (screenshareCheck != event.stream.id && event.type !== 'local') {
            ...
            heading.setAttribute("style", 'width:' + (Math.round(window.innerHeight * 0.30) - 10) + 'px;height:30px;padding:5px;text-align: center;background-color:#008cba;color:#fff;');
            video.setAttribute("style", "background: #e0ecee;border: 1px solid #008cba;border-top:none;float:left;");
